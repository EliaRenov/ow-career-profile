...
const HeroComparisonTable = ({stat}) => {
    ...
    return (
        <div className="hero-comparison-table">
            {comparison.map(hero => {
                return <HeroComparisonCell data={hero} heroes={Heroes} mostPlayed={mostPlayed} key={hero.hero} type={stat} setCurrentTab={setCurrentTab} setCurrentHero={setCurrentHero} />
